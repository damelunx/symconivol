...
#'
#' The symconivol package provides functions for ...
#'
#' \code{symconivol} supports ... Stan.
#'
#' @section Functions:
#' \itemize{
#'   \item \code{\link[symconivol]{constr_eigval}}: ...
#'   \item \code{\link[symconivol]{prepare_em_cm}}: ...
#'   \item \code{\link[symconivol]{estim_em_cm}}: ...
#' }
#'
#' @section See also:
#' \describe{
